...
Dernière mise à jour : 7 mai 2026 — **Voie D Dashboard Cockpit en cours**. PR-D1 (#94) ✅ + PR-D2 (#96) ✅ + **PR-D3 (#121) ✅ + PR-D3-bis (#122) ✅** mergées. Hors-Voie D mergées 6 mai : PR #117 (THI-122 404 + error boundary), #118 (fix identité Vanmeeteren 5 locales), #119 (logo footer cliquable), #120 (PR-LEGAL-1 cookies management RGPD). Sprint Mobile Recovery Ankora ✅ clos. Prochaine étape : **PR-UI-2 fixes UI charges/expenses régressions visuelles** (focus emerald + scroll spinner + date icon dark) **aujourd'hui 7 mai** + **PR-QA-1d Playwright stability** (en parallèle CC Ankora) + Session Claude Design #3 weekend 10-11 mai + **PR-D4 enrichi** (édition inline + dates + toggle paye + visual layer CD#3) à partir du 11 mai. **Décision Option B tranchée 6 mai par @cowork** (carte blanche @thierry) : alpha @thierry + 2-3 proches 4-6 sem, **PAS de release publique 10 mai**, v1.0 publique mi-juin. Cf. [ADR-005](./adr/ADR-005-pr3a-anticipated-design-system.md) + handoff Obsidian `Athenaeum/10_Projects/ankora/cowork-handoffs/2026-05-06-2230-feedback-post-pr-d3-dette-ux.md`.
