...
| 11  | **Voie D — Dashboard Cockpit complet (PR-D1 → PR-D8)**     | 📋 spec canonique livrée 3 mai 2026 (`specs/dashboard-cockpit-vraie-vision-2026-05-03.md`), 5 ADRs (008-012) en `Proposed`. Voir section "Voie D" plus bas.                              | —             | Refactor complet vers la vraie vision IronBudget : Effort Lissé, Capacité Réelle, Assistant Virements, Plan rattrapage, Live Quotidien, Simulateur d'Action |
