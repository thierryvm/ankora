...
| 9   | **PR Dashboard v3 (Pilier B/C)**                      | 📋 handoff dormant A4 (cf. `90_Meta/cc-prompts-en-attente.md` du vault Athenaeum) — pré-requis : Session Claude Design #3                                                                | —             | 8 sections obligatoires Monarch-level (cashflow waterfall, health score, timeline 6m, etc.) |
