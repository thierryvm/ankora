...
| #   | Preuve                                                                                                                                                                                                                                                                                                                                                             | Instrument                                                                       |
| --- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------- |
| 1   | Un `UPDATE` direct sur `paid_from_account_type` est **refusé**. Formulation exacte : ce n'est **pas** « l'attribution est immuable » — décocher supprime la ligne, donc décocher/recocher réattribue librement ([#361](https://github.com/thierryvm/ankora/issues/361)). Le trigger protège contre un `update` oublié dans une future Server Action, rien de plus. | **spec e2e authentifiée**                                                        |
