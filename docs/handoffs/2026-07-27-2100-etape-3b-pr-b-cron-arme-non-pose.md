...
- **NE PAS se servir du MCP Supabase pour vérifier la production** : il est branché sur le
  **compte professionnel** et ne voit pas Ankora.
...
- **NE PAS exécuter un prompt tagué pour le projet professionnel** — autre projet,
  autre compte. Un tel prompt est arrivé dans cette session le 27 juillet et n'a pas
  été exécuté.
